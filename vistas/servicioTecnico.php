<?php $pageTitle = 'Servicio Tecnico'; ?>
...
<?php require 'layout/sidebar.php'; ?>
  <div class="container-fluid pt-4">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="tblServicioTecnico" class="table color-table inverse-table" style="width:100%">
    ...
    <div class="modal fade" id="modalServicioTecnico" tabindex="-1">
      <div class="modal-dialog">
        <form id="formServicioTecnico" class="modal-content">
          <div class="modal-header bg-primary text-white">
            <h5 class="modal-title">Nuevo Servicio Tecnico</h5>
