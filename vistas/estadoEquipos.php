...
<div class="page-wrapper">
  <div class="container-fluid pt-4">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="tblEstadoEquipos" class="table color-table inverse-table" style="width:100%">
    ...
    <div class="modal fade" id="modalEstadoEquipos" tabindex="-1">
      <div class="modal-dialog">
        <form id="formEstadoEquipos" class="modal-content">
          <div class="modal-header bg-primary text-white">
            <h5 class="modal-title">Nuevo Estado Equipos</h5>
