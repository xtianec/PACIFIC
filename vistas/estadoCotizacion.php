<?php $pageTitle = 'Estado Cotizacion'; ?>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="tblEstadoCotizacion" class="table color-table inverse-table" style="width:100%">
      ...
      <div class="modal-dialog">
        <form id="formEstadoCotizacion" class="modal-content">
          <div class="modal-header bg-primary text-white">
            <h5 class="modal-title">Nuevo Estado Cotizacion</h5>
...
<script src="js/estadoCotizacion.js"></script>
